...
# load data frame with all calls from 24 data files
load(file="~/Dropbox/Projects/FrogCalls/power/all_calls.RData")

# function fpow computes frequency distrubutions for interruptions at variety
# of calling activity levels (ncalls) through simulation, drawing  
# bf:gf ration, and calling durations from empirical data (all.calls) 
